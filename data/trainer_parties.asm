...
SabrinaData:
	...
	db 43,ALAKAZAM
	moveset LICK, RECOVER, PSYWAVE, REFLECT
	db $FF
...
GiovanniData:
	...
	db 29,KANGASKHAN
	moveset MEGA_PUNCH, MEGA_PUNCH, BITE, TAIL_WHIP
	db $FF
	...
	db 35,ONIX
	moveset CUT, BIND, RAGE, ROCK_THROW
	
	db 37,RHYHORN
	moveset FURY_ATTACK, LEER, STOMP, BARRAGE
...
Green2Data:
	...
	db 37,PIDGEOT
	moveset WING_ATTACK, WING_ATTACK, QUICK_ATTACK, WHIRLWIND
	...
	db 35,ALAKAZAM
	moveset LICK, AMNESIA, REFLECT, RECOVER
...
SwimmerFData:
BeautyData:
	db "Charlotte@",24,ODDISH,GLOOM,$FF
...
BirdKeeperData:
	...
	db "Jim@",26,SPEAROW,FEAROW,$FF
	db "Eric@",29,PIDGEOTTO,FEAROW,$FF
	db "Chris@",28,SPEAROW,FEAROW,$FF
...
RocketData:
	...
	db "Executive@",CUSTOM_PIC,EXECUTIVE_M,23,KOFFING,$FF
