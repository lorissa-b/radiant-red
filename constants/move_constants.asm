const_value = 1
	...
	const STEEL_WING   ; b4
	const IRON_HEAD    ; b5
	const FLASH_CANNON ; b6
	const STRUGGLE_BUG ; b7
	const SILVER_WIND  ; b8
	const SIGNAL_BEAM  ; b9
	const X_SCISSOR    ; ba
	const DRAGON_DANCE ; bb
	const TWISTER      ; bc
	const DRAGONBREATH ; bd
	const DRAGON_CLAW  ; be
	const OUTRAGE      ; bf
	const SHOCK_WAVE   ; c0
	const SPARK        ; c1
	const THUNDER_FANG ; c2
	const ARM_THRUST   ; c3
	const MACH_PUNCH   ; c4
	const DRAIN_PUNCH  ; c5
	const SKY_UPPERCUT ; c6
	const CROSS_CHOP   ; c7
	const WILL_O_WISP  ; c8
	const FLAME_CHARGE ; c9
	const FIRE_FANG    ; ca
	const LAVA_PLUME   ; cb
	const AERIAL_ACE   ; cc
	const ASTONISH     ; cd
	const SHADOW_SNEAK ; ce
	const SHADOW_PUNCH ; cf
	const SHADOW_BALL  ; d0
	const PHANTOMFORCE ; d1
	const SYNTHESIS    ; d2
	const MAGICAL_LEAF ; d3
	const GIGA_DRAIN   ; d4
	const LEAF_BLADE   ; d5
	const PETALBLIZARD ; d6
	const MUD_SLAP     ; d7
	const MUD_SHOT     ; d8
	const ICICLE_SPEAR ; d9
	const ICE_SHARD    ; da
	const POWDER_SNOW  ; db
	const ICE_FANG     ; dc
	const SHEER_COLD   ; dd
	const POISON_FANG  ; de
	const POISON_JAB   ; df
	const SLUDGE_BOMB  ; e0
	const GUNK_SHOT    ; e1
	const EXTRASENSORY ; e2
	const ZEN_HEADBUTT ; e3
	const ROCK_BLAST   ; e4
	const ANCIENTPOWER ; e5
	const POWER_GEM    ; e6
	const STONE_EDGE   ; e7
	const WATER_PULSE  ; e8
	const SCALD        ; e9
	const MUDDY_WATER  ; ea
